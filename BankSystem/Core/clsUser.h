...
private:
    ...
    static stLoginRegisterRecord _ConvertLoginRegisterLineToRecord(string Line, string Seperator = "#//#")
    {
        ...
        vLoginRegisterRecord = clsString::SplitString(Line, Seperator);
...
public:
    ...
    enum enPermissions{eAll = -1 , pListUser = 1,pAddNewUser =2 , pDeleteuser = 4,
    pUpdateUser = 8 , pFindUser = 16 , pTransactions = 32 , pManageUsers = 64 , pLoginRegister = 128};
    ...
    static vector<clsUser> GetUsersList() {
     ...
     bool CheckAccessRight(enPermissions Permissions)
    {
